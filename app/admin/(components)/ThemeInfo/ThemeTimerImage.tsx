...
import DeleteDialog from "@/(shared)/components/Dialog/TimerImageDelete/Dialog";
import PreviewDialog from "@/(shared)/components/Dialog/Preview/Dialog";
import Dialog from "@/(shared)/components/Dialog/Image/Dialog";
