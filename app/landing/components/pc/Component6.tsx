      ...
      <div className="pc-faq-wrapper">
        ...
        >
          ...
          <div className="faq-answer">
            ...
            있어요.
            <br />
            타이머 화면의 배경을 테마 분위기에 맞게 커스텀하는 기능도 제공해요.
            <br />더 자세한 내용은{" "}
            <Link href="https://www.notion.so/107febdc0ad180f09f68fc47e1f4fde2?pvs=21">
              여기
            </Link>
            에서 확인해 보세요.
          </div>
        ...
        >
          <div className="pc-faq-title">
            <div className="pc-faq-title">힌트 코드에는 숫자밖에 못쓰나요?</div>
            <span className="arrow" />
          </div>
          <div className="faq-answer">
            넥스트룸은 숫자만 지원하고 있습니다.
